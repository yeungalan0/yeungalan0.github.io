...
\vspace{-.25em}
\cventry
{Engineering Leadership Development Program rotation 2 - Software Engineer} % Job title
...
\vspace{-1.25em}
\cventry
{Engineering Leadership Development Program rotation 1 - Full Stack Engineer} % Job title
{Lockheed Martin} % Organization
{Littleton, CO} % Location
{July 2018 - August 2019} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
