...
\geometry{left=1.7cm, top=1.2cm, right=1.7cm, bottom=1.2cm, footskip=0cm} % Configure page margins with geometry
...
\name{Alan}{Yeung}
\address{45 Estack Place, Highlands Ranch, CO 80126}
\mobile{(303)-997-2440}
...
\quote{``Intellectuals solve problems, geniuses prevent them." - Albert Einstein} % A quote or statement
...
\renewcommand{\arraystretch}{.85} % General space between rows (1 standard)
